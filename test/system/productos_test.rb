...
class ProductosTest < ApplicationSystemTestCase
  ...
  test "should create producto" do
    ...
    fill_in "Fecha baja", with: @producto.fecha_baja
    fill_in "Fecha ingreso", with: @producto.fecha_ingreso
    fill_in "Fecha modificacion", with: @producto.fecha_modificacion
    fill_in "Nombre", with: @producto.nombre
    fill_in "Precio", with: @producto.precio
    fill_in "Stock", with: @producto.stock
    fill_in "Talle", with: @producto.talle
  ...
  test "should update Producto" do
    ...
    fill_in "Color", with: @producto.color
    fill_in "Descripcion", with: @producto.descripcion
    fill_in "Fecha baja", with: @producto.fecha_baja.to_s
    fill_in "Fecha ingreso", with: @producto.fecha_ingreso.to_s
    fill_in "Fecha modificacion", with: @producto.fecha_modificacion.to_s
    fill_in "Nombre", with: @producto.nombre
    fill_in "Precio", with: @producto.precio
    fill_in "Stock", with: @producto.stock
    fill_in "Talle", with: @producto.talle
